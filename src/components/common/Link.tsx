...
const Link = React.forwardRef<HTMLAnchorElement, LinkProps>(function Link(props, ref) {
	...
	if (isExternal) {
		if (noLinkStyle) return <a className={className} href={href} ref={ref} {...other} />;

		return <MuiLink className={className} href={href} ref={ref} {...other} />;
	}

	if (noLinkStyle) return <NextLinkComposed className={className} ref={ref} to={href} linkAs={linkAs} {...other} />;
